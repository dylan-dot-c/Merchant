          ...
          <div className="mt-4 px-4 pt-2 md:px-8">
            ...
            <div className="flex justify-between items-center mt-2 mb-4 p-2 bg-gray-300 rounded-md ">
              <div className="flex space-x-2">
                ...
                <div className="text-xs mt-1 text-gray-600 uppercase">HOMEWORLD </div>
              </div>
              <div>{planet}</div>
            </div>
              ...
              return (
                ...
                >
                  <div className="flex space-x-2">
                    ...
                    <div className="text-xs mt-1 text-gray-600 uppercase">VEHICLES </div>
                  </div>
                  <div>{vehicle}</div>
                </div>
              );
              ...
              return (
                ...
                >
                  <div className="flex space-x-2">
                    ...
                    <div className="text-xs mt-1 text-gray-600 uppercase">Starship </div>
                  </div>
                  <div>{starShip}</div>
                </div>
              );
